...
mouse = new THREE.Vector3( 20, 20, 20 );
    ...
    function init() {
        ...
        //sphere
        texture = new THREE.TextureLoader().load('Gallery_Studio2rev.jpg');
        ...
        //button1
        buttontext1 = new THREE.TextureLoader().load('Gallery_lobby.jpg');
        ...
        button1.position.set(400, -60, -30)
        ...
        popup1.position.set(10, -31.2, 147)
        popup1.lookAt(-60, -25, 0)
        scene.add( popup1 );
        ...
        popup2.position.set(-115, -46.3, -150)
        popup2.lookAt(-35, -50, 0)
        scene.add( popup2 );
        ...
        geometry = new THREE.CircleGeometry( 1.3, 128 );
        material = new THREE.MeshBasicMaterial( {map:popuptext3});
        popup3 = new THREE.Mesh( geometry, material );
        popup3.position.set(38.5, -24.5, -200)
        popup3.lookAt(100, 0, 300)
        scene.add( popup3 );
        ...
        geometry = new THREE.CircleGeometry( 1, 128 );
        material = new THREE.MeshBasicMaterial( {map:popuptext4});
        popup4 = new THREE.Mesh( geometry, material );
        popup4.position.set(119, -19.5, -200)
        popup4.lookAt(100, 0, 300)
        scene.add( popup4 );
        ...
        geometry = new THREE.CircleGeometry( 1.1, 128 );
        material = new THREE.MeshBasicMaterial( {map:popuptext5});
        popup5 = new THREE.Mesh( geometry, material );
        popup5.position.set(180, -16.5, -200)
        popup5.lookAt(-250, 0, 0)
        scene.add( popup5 );
        ...
        popup6.position.set(263, -25.5, -150.6)
        popup6.lookAt(0, 0, 0)
        scene.add( popup6 );
    ...
    function closeMe1()
{
    location.replace("index11 copy 3.html")
}
