...
mouse = new THREE.Vector3( 20, 20, 20 );
    ...
    function init() {
        ...
        //sphere
        texture = new THREE.TextureLoader().load('Networking.jpg');
        ...
        //button2
        buttontext2 = new THREE.TextureLoader().load('EnterChatroom.jpg');
        geometry = new THREE.PlaneGeometry( 30, 8 );
        material = new THREE.MeshBasicMaterial( {map:buttontext2});
        button2 = new THREE.Mesh( geometry, material );
        button2.position.set(200, -90, -60)
        ...
        //button3
        buttontext3 = new THREE.TextureLoader().load('ArtGallery.jpg');
        geometry = new THREE.PlaneGeometry( 43, 10 );
        material = new THREE.MeshBasicMaterial( {map:buttontext3});
        button3 = new THREE.Mesh( geometry, material );
        button3.position.set(155, 40, -300)
        ...
        //button4
        buttontext4 = new THREE.TextureLoader().load('Label_Information.jpg');
        ...
        button4.position.set(280, 32, 390)
        button4.lookAt(-400, 0, 0)
        scene.add( button4 );
    ...
    control.minPolarAngle = Math.PI / 2.5;
